...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("mazacoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No MazaCoin application found.\nPlease install MazaCoin Wallet.", Toast.LENGTH_LONG).show();
